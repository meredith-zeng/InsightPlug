...
export const Icons = {
  Zap: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 14.71V11c0-2.2 1.8-4 4-4h4V4l8 10-8 10v-3H8c-2.2 0-4-1.8-4-4Z"/></svg>
  ),
  Car: (props: any) => (
